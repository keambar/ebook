...
public class AnimButtons extends RelativeLayout {
  ...
  protected void onFinishInflate() {
    ...
    View view = LayoutInflater.from(context).inflate(R.layout.anim_button,
        this);
  ...
  private void initButtons(View view){
    // 可以根据按钮的个数自己增减
    btns = new Button[3];
    btns[0] = (Button) view.findViewById(R.id.btn_shop);
    
    
    btns[1] = (Button) view.findViewById(R.id.btn_bookshelf);
    btns[2] = (Button) view.findViewById(R.id.btn_setting);
