package com.example.ebook.menus;
...
public class TxtProgressMenu extends PopupWindow {
	...
	private void inite() {
		...
		this.setOutsideTouchable(true);//点击外区域关闭
		this.setContentView(layout);
		this.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);//处理键盘遮挡问题
